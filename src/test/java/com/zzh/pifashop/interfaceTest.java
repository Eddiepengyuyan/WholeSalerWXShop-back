...
class interfaceTest {
    ...
    public void setUp() throws Exception {
        mvc = MockMvcBuilders.standaloneSetup(new ItemsController()).build();
    ...
    void itemListTest() throws Exception {
        setUp();
        String responseString = mvc.perform(MockMvcRequestBuilders.post("/itemList").accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk())    //返回的状态是200
